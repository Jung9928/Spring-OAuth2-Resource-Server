...
* The original package name 'com.example.Spring-OAuth2-Resource-Server' is invalid and this project uses 'com.example.Spring_OAuth2_Resource_Server' instead.
